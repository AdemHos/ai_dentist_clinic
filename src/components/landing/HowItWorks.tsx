...
const HowItWorks = () => {
  return (
    <section className="relative px-6 py-32 outline-hidden max-w-7xl z-10">
      {/* HEADER */}
      <div className="text-center mb-20">
        <div
          className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-primary/10 to-primary/5
       rounded-full backdrop-blur-sm border border-primary/10 mb-6"
        >
      ...
      <div className="relative">
        {/* CONNECTION LINE */}
        <div
          className="absolute top-1/2 left-0 right-0 h-px bg-linear-to-r from-transparent via-primary/30
